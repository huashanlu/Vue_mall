                                    ...
                                    <div class="center-nav">
                                        <ul>
                                            <li>
                                                ...
                                                <div class="list">
                                                    <p>
                                                        <router-link to="/site/myOrders" class="">
                                    ...
                                    <div class="order-progress">
                                        <ul>
                                            <li class="first active">
                                                ...
                                                <div class="info">{{order.orderinfo.add_time | moment("YYYY-MM-DD HH:mm:ss")}}</div>
                                            </li>
                                            <li :class="order.orderinfo.status >= 2 ? 'active':''">
                                                <div class="progress">已付款</div>
                                                <div class="info">{{order.orderinfo.payment_time | moment("YYYY-MM-DD HH:mm:ss")}}</div>
                                            </li>
                                            <li :class="order.orderinfo.status >= 3 ? 'active':''">
                                                <div class="progress">已经发货</div>
                                                <div class="info">{{order.orderinfo.express_time | moment("YYYY-MM-DD HH:mm:ss")}}</div>
                                            </li>
                                            <li :class="[order.orderinfo.status >= 3 ? 'active':'','last']">
                                                <div class="progress">已完成</div>
                                                <div class="info">{{order.orderinfo.complete_time | moment("YYYY-MM-DD HH:mm:ss")}}</div>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="form-box accept-box form-box1">
                                        <dl class="head form-group">
                                            <dd>
                                                ...
                                                <a href="#/site/goods/payment/12" class="btn-pay">{{order.orderinfo.statusName}}</a>
                                                <!---->
                                            </dd>
                                        </dl>
                                        <dl class="form-group">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td colspan="7" align="right">
                                                        <p>商品金额：
                                                            <b class="red">￥{{getTotalAmount}}</b>&nbsp;&nbsp;+&nbsp;&nbsp;运费：
                                                            <b class="red">￥{{order.orderinfo.express_fee}}</b>
                                                        </p>
                                                        <p style="font-size: 22px;">应付总金额：
                                                            <b class="red">￥{{getTotalAmount+order.orderinfo.express_fee}}</b>
                                                        </p>
                                                    </td>
                                                </tr>
                                            </tbody>
    ...
    export default {
        ...
        computed:{
            ...
            getTotalAmount(){
                let totalAmount = 0
                this.order.goodslist.forEach(item => {
                    totalAmount+=item.quantity*item.real_price
                });
